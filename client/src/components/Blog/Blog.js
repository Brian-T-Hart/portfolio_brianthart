		...
		<div className="row flex-column flex-sm-row justify-content-around align-items-center mh-60">
			<Link to="/blog/1">
				<div className="d-flex flex-column mb-3">
					<img alt="Web design graphic with computer screen, mouse and keyboard" className="blog-section-image" src="https://cdn.pixabay.com/photo/2018/05/18/15/30/webdesign-3411373_960_720.jpg" ></img>
			...
			<Link to="/blog/2">
				<div className="d-flex flex-column mb-3">
					<img alt="Cloud computing graphic" className="blog-section-image" src="https://www.publicdomainpictures.net/pictures/290000/velka/web-hosting.jpg"></img>
